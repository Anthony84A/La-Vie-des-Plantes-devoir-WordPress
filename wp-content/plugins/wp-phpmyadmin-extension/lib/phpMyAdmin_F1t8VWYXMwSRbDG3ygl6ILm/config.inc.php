...
$cfg['blowfish_secret']					= 'jsrzn0W{!bmk<ZT9PF@t>OSd&ESfUFZY' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/WordPress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_F1t8VWYXMwSRbDG3ygl6ILm/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://localhost/WordPress/wp-admin/?rand=99864042&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://localhost/WordPress/wp-admin/?rand=88638283&pma_logout=1';
